export default {
    ...
    hero: {
        ...
        install_btn: '安装',
        ios_install_title: '安装在 iPhone 上',
        ios_install_desc: '要安装此应用程序，请点击浏览器中的“分享”按钮：',
        ios_install_step1: '点击“分享”按钮',
        ios_install_step2: '选择“添加到主屏幕”',
        close: '关闭'
    },
    home: {
        b2c: {
    ...
    contacts_page: {
        ...
        address_title: '我们的地址',
        address: '1. 阿拉木图市, Altynsarin 街 26 号\n2. Timiryazeva 53\n3. Shugyla City 340/4\n4. Shugyla City 340/33 k4\n5. Zhetysu 1, 46a\n6. Severnoe Koltso 29/5a\n7. Zerdeli 1/153',
        phone_title: '电话',
        phone_sub: '(Whatsapp / Telegram)',
        schedule_title: '工作时间',
        schedule_days: '周三至周日: 10:00 - 20:00',
        schedule_off: '周一，周二 - 休息',
    ...
    admin: {
        ...
        clean_broken_btn: '清理损坏记录',
        cleaning_broken: '清理中...',
        confirm_clean_broken: '删除所有无效跟踪号码的记录？这将从数据库中移除损坏的记录。',
        clean_broken_success: '成功删除 ',
        records_deleted: '条记录',
        clean_broken_error: '清理损坏记录时出错',
        clean_sheet_btn: '清理表格',
        cleaning_sheet: '清理中...',
        confirm_clean_sheet: '从Google表格中删除所有损坏记录？这将从电子表格中移除无效行。',
        clean_sheet_success: '成功删除 ',
        sheet_rows_deleted: '表格行',
    ...
    auth_pages: {
        ...
        email: {
            ...
            submit_loading: '发送中...',
            next_btn: '下一步',
            terms_agree_full: '我接受公开要约和隐私政策的条款',
            back_to_form: '返回',
            back: '← 返回登录',
    ...
    public_offer_page: {
        ...
        sections: [
            {
                title: '1. 一般规定',
                text: '1.1. 本公司提供货物接收、集运、仓储和配送服务。\n1.2. 本公司不是商品的制造商或销售商，仅提供物流服务。\n1.3. 用户对货物信息的真实性承担全部责任。'
            },
            {
                title: '2. 货物责任',
                text: '2.1. 如果货物属于以下情况，用户有义务提前通知本公司：',
                list: [
                    '易碎品;',
                    '易损坏;',
                    '需要额外包装或打木架。'
            ...
            {
                title: '',
                text: '2.2. 如果用户未警告货物的易碎性（例如：玻璃、镜子、陶瓷等），➡️ 所有可能的损坏责任由用户承担。\n\n2.3. 如果出现以下情况，本公司不对货物损坏负责：',
                list: [
                    '未订购打木架;',
                    '用户拒绝额外包装;',
                    '提供的货物信息不正确。'
            ...
            {
                title: '3. 打木架和额外包装',
                text: '3.1. 打木架是一项额外的付费服务。\n3.2. 是否需要打木架由用户决定。\n3.3. 如果拒绝打木架，用户承担与货物可能损坏相关的所有风险。'
            },
            {
                title: '4. 禁止运输的货物 🚫',
                text: '本公司不接受或运输以下类别的货物：',
                list: [
                    '🔴 武器、弹药及其部件',
                    '🔴 麻醉品、精神药物',
                    '🔴 易爆、易燃物质',
            ...
            {
                title: '',
                text: '⚠️ 如果发现违禁货物，所有责任（罚款、没收、延误）由用户承担。'
            },
            {
                title: '5. 交付条款',
                text: '5.1. 指示的交付时间仅供参考。\n5.2. 由于本公司无法控制的原因可能会出现延误：',
                list: [
                    '海关检查;',
                    '天气条件;',
                    '第三方行为。'
            ...
            {
                title: '6. 个人数据和隐私 🔐',
                text: '6.1. 用户同意处理其个人数据：全名、电话号码、货物和交付数据。\n6.2. 数据仅用于提供服务，除法律要求外，不向第三方转让。'
            },
            {
                title: '7. 最后条款',
                text: '7.1. 在网站上注册并勾选“我同意条款”框即表示：',
                list: [
                    '完全接受要约条款;',
                    '同意运输规则;',
                    '同意责任分配。'
            ...
            {
                title: '',
                text: '7.2. 本公司保留在不事先通知的情况下更改要约条款的权利。'
            }
        ],
        back: '← 返回首页'
    }
