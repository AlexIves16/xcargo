export default {
    ...
    admin: {
        ...
        clean_broken_btn: 'Очистить битые записи',
        cleaning_broken: 'Очистка...',
        confirm_clean_broken: 'Удалить все записи с некорректными трек-номерами? Это действие удалит битые записи из базы данных.',
        clean_broken_success: 'Успешно удалено ',
        records_deleted: 'записей',
        clean_broken_error: 'Ошибка при очистке битых записей',
        clean_sheet_btn: 'Очистить таблицу',
        cleaning_sheet: 'Очистка...',
        confirm_clean_sheet: 'Удалить все битые записи из Google Таблицы? Это действие удалит некорректные строки из таблицы.',
        clean_sheet_success: 'Успешно удалено ',
        sheet_rows_deleted: 'строк из таблицы',
