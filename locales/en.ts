export default {
    ...
    admin: {
        ...
        clean_broken_btn: 'Clean Broken Records',
        cleaning_broken: 'Cleaning...',
        confirm_clean_broken: 'Delete all records with invalid tracking numbers? This will remove broken records from the database.',
        clean_broken_success: 'Successfully deleted ',
        records_deleted: 'records',
        clean_broken_error: 'Error cleaning broken records',
        clean_sheet_btn: 'Clean Sheet',
        cleaning_sheet: 'Cleaning...',
        confirm_clean_sheet: 'Delete all broken records from Google Sheet? This will remove invalid rows from the spreadsheet.',
        clean_sheet_success: 'Successfully deleted ',
        sheet_rows_deleted: 'rows from sheet',
    ...
    privacy_page: {
        ...
        sections: [
            ...
            {
                title: '2. Data We Collect', text: 'To operate the application and provide services, we collect the following types of data:', list: [
            ...
            {
                title: '3. Purpose of Data Use', text: 'Your data is used for:', list: [
