  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-100">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
      ...
      <button 
        ...
        class="w-full flex items-center justify-center gap-3 bg-[#0088cc] text-white font-medium py-3 px-4 rounded-lg hover:bg-[#006699] transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0088cc] mb-3"
      >
        ...
        <span v-if="telegramPolling">Подтвердите в Telegram...</span>
        <span v-else>Войти через приложение Telegram</span>
      </button>

      <!-- Fallback: Widget login -->
      <div class="text-center text-sm text-gray-500 mb-3">
        или используйте виджет:
      </div>
